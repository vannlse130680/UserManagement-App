    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (searchValue == null) {
                ...
                userDao.searchUserByName("");

                List<Tbl_UserDTO> result = userDao.getListUser();
                ...
                Tbl_UserDAO userDao = new Tbl_UserDAO();
                if (role == null) {
                    userDao.searchUserByName(searchValue.trim());
                } else if (role.isEmpty()) {
                    userDao.searchUserByName(searchValue.trim());

                } else {
                    int roleId = Integer.parseInt(role);
                    userDao.searchUserByNameAndRole(searchValue.trim(), roleId);
                }
