 ...
 * @author Acer
 */
@WebServlet(name = "PreInsertServlet", urlPatterns = {"/PreInsertServlet"})
public class PreInsertServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("PreInsertServlet _ SQLException" + ex.getMessage());
        } catch (NamingException ex) {
            log("PreInsertServlet _ NamingException" + ex.getMessage());
        } finally {
