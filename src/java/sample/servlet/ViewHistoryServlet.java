...
import sample.tbl_promotion.Tbl_PromotionDTO;
...
private static final String HISTORY_PAGE = "history.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            dao.loadHistory();
            List<Tbl_PromotionDTO> history = dao.getHistory();
            request.setAttribute("HISTORY", history);
        } catch (SQLException ex) {
            log("ViewHistoryServlet _ SQLException" + ex.getMessage());
        } catch (NamingException ex) {
            log("ViewHistoryServlet _ NamingException" + ex.getMessage());
        } finally {
